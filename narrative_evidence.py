...
CAUSAL_MARKERS = ("主要系", "所致", "由于", "原因", "影响", "导致", "带动", "推动",
                  ...
                  # D3：真实年报的"环境 + 应对"式解释——洋河 2024 年报原文：
                  # "白酒行业进入存量竞争阶段，市场竞争更加白热化，公司主力产品集中的
                  # 中端和次高端价位段承压较大……积极调整经营策略，应对外部环境的变化"
                  # 一个现有标记都不命中，导致真实经营讨论进不了"变化解释"（正向分支缺口）。
                  "承压", "存量竞争", "竞争加剧", "白热化", "经营策略", "应对外部环境",
                  "外部环境")

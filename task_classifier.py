...
_NON_COMPANY_FRAGMENTS = (
    # 指标词的碎片（"营业收入"被懒匹配切出"营业"）：报告表格单元里极易出现
    "营业", "收入", "营收", "净利", "利润", "毛利", "现金", "每股", "资产",
    "负债", "业绩", "增长", "同比", "环比", "总额", "合计", "小计",
    # 指标词前缀（"归母净利润"被兜底模式切出"归母"）：F1 实机简报里每个
    # "归母净利润 …"行都被判成"别家公司"→ 该数字不可溯源（溯源率掉到 74%）
    "归母", "归属", "净额", "流量", "投入", "费用", "成本", "收益率", "利率",
    # 报告/材料里的泛称（"用户材料口径收入 1200 万元"曾把"口径"当成公司）
    "材料", "口径", "用户", "数据", "报告", "分析", "对比", "变化", "趋势",
    "情况", "表现", "摘要", "结论", "附录", "备注", "说明", "正文", "表格",

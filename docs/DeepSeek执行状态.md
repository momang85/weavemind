...
**当前批次**：F3-C / C3（成稿精简为研究员可用的简报）——三条落地，三场景全通过。
证据：`docs/evidence/c3_brief_shape_20260920.md`；
C2 见 `c2_claim_evidence_support_20260920.md`，C1 见 `c1_export_and_review_honesty_20260920.md`。

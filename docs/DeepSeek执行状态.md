...
**当前批次**：F3-C / C1（导出可用性与复核记录诚实性）——五条落地，三场景重跑全通过。
证据：`docs/evidence/c1_export_and_review_honesty_20260920.md`；
F3-B 见 `f3b_charts_revision_scenarios_20260920.md`，F3-A 见 `f3a_semantics_admission_20260920.md`。

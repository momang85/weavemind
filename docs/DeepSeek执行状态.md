...
**当前批次**：F3-C / C2（从"来源准入"推进到"结论受支持"）——六条落地。
证据：`docs/evidence/c2_claim_evidence_support_20260920.md`；
C1 见 `c1_export_and_review_honesty_20260920.md`，F3-B 见 `f3b_charts_revision_scenarios_20260920.md`。

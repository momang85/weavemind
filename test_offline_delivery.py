...
RESEARCH_REPORT_BODY = (
    ...
    # 分析正文：研究简报只保留这一节，且"分析未完成"是交付硬门槛的判据——
    # 夹具要像一份真的写了分析的模型稿（否则离线正例会被正确判成"分析未完成"）
    "## 分析与结论\n\n"
    "营业收入 2024 年为 1741.44亿元，较 2023 年的 1505.6亿元增长 15.66%；"
    "归母净利润 862.28亿元，同比增长 15.38%，与收入增速接近。"
    "经营活动现金流净额 924.64亿元，同比增长 38.85%，增速明显高于收入与利润，"
    "当期经营现金流高于归母净利润。\n\n"
    "变化原因方面：营业收入变动主要系本期销量增加及产品结构变化所致，"
    "该项在本次取得的年报段落中有对应说明；归母净利润与收入增速的差异来源"
    "（产品结构、税金及附加、期间费用等）原因未在本次资料中体现，"
    "需核查合并利润表及财务附注相关小节。\n\n"
    "风险与结论：两期数据只能说明这两期的变化，不能据此声称长期趋势；"
    "本次未取得同业与行情数据，不给出估值或目标价。\n\n"
